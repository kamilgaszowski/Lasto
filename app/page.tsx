...
// --- IKONY  ---
const RuneArrowLeft = () => (
  <span className="icon-md icon-bold icon-square">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16 4l-10 8 10 8" /></svg>
  </span>
);

const RuneArrowRight = () => (
  <span className="icon-md icon-bold icon-square">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M8 4l10 8-10 8" /></svg>
  </span>
);

const SettingsIcon = () => (
  <span className="icon-xl icon-thin">
...
const EditIcon = () => (
  <span className="icon-md icon-normal">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" /></svg>
  </span>
);

const CheckIcon = () => (
  <span className="icon-md icon-normal">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4.5 12.75l6 6 9-13.5" /></svg>
  </span>
);

const CloseIcon = () => (
  <span className="icon-lg icon-normal">
...
const SunIcon = () => (
  <span className="icon-md icon-normal">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>
  </span>
);

const MoonIcon = () => (
  <span className="icon-md icon-normal">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" /></svg>
  </span>
);

const InfoIcon = () => (
  <span className="icon-lg icon-normal">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" /></svg>
  </span>
);
